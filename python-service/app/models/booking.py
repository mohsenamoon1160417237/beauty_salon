...
class Appointment(Base):
    ...
    status = Column(Enum(BookingStatus, name="booking_status", create_type=False, values_callable=lambda x: [e.value for e in x]), default=BookingStatus.PENDING, nullable=False)
